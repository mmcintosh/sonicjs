...
type Plugin$1 = typeof plugins.$inferSelect;
type NewPlugin = typeof plugins.$inferInsert;
type PluginHook$1 = typeof pluginHooks.$inferSelect;
...
declare class Logger {
     ...
     */
    getLogById(id: string): Promise<any | null>;
    /**
...
export { selectCollectionSchema as $, type Migration as A, type MigrationStatus as B, type LogLevel as C, type LogCategory as D, type LogEntry as E, type LogFilter as F, type CorePlugin as G, users as H, collections as I, content as J, contentVersions as K, Logger as L, MigrationService as M, media as N, apiTokens as O, type PluginBuilderOptions as P, workflowHistory as Q, plugins as R, pluginHooks as S, pluginRoutes as T, pluginAssets as U, pluginActivityLog as V, systemLogs as W, logConfig as X, insertUserSchema as Y, selectUserSchema as Z, insertCollectionSchema as _, type Plugin as a, insertContentSchema as a0, selectContentSchema as a1, insertMediaSchema as a2, selectMediaSchema as a3, insertWorkflowHistorySchema as a4, selectWorkflowHistorySchema as a5, insertPluginSchema as a6, selectPluginSchema as a7, insertPluginHookSchema as a8, selectPluginHookSchema as a9, type PluginAsset as aA, type NewPluginAsset as aB, type PluginActivityLog as aC, type NewPluginActivityLog as aD, type SystemLog as aE, type NewSystemLog as aF, type LogConfig as aG, type NewLogConfig as aH, insertPluginRouteSchema as aa, selectPluginRouteSchema as ab, insertPluginAssetSchema as ac, selectPluginAssetSchema as ad, insertPluginActivityLogSchema as ae, selectPluginActivityLogSchema as af, insertSystemLogSchema as ag, selectSystemLogSchema as ah, insertLogConfigSchema as ai, selectLogConfigSchema as aj, type User as ak, type NewUser as al, type Collection as am, type NewCollection as an, type Content as ao, type NewContent as ap, type Media as aq, type NewMedia as ar, type WorkflowHistory as as, type NewWorkflowHistory as at, type Plugin$1 as au, type NewPlugin as av, type PluginHook$1 as aw, type NewPluginHook as ax, type PluginRoute as ay, type NewPluginRoute as az, type PluginRoutes as b, type PluginRouteOpenAPI as c, type PluginMiddleware as d, type PluginModel as e, type PluginService as f, type PluginAdminPage as g, type PluginMenuItem as h, type PluginComponent as i, type PluginHook as j, loadCollectionConfig as k, loadCollectionConfigs as l, getAvailableCollectionNames as m, syncCollections as n, syncCollection as o, isCollectionManaged as p, getManagedCollections as q, registerCollections as r, schema as s, cleanupRemovedCollections as t, fullCollectionSync as u, validateCollectionConfig as v, getLogger as w, initLogger as x, PluginService$1 as y, PluginBootstrapService as z };
