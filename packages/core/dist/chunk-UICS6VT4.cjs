...
async function verifyTurnstile(c, next) {
  ...
  const turnstileService = new chunkQKE5AQHO_cjs.TurnstileService(db);
...
new chunkQKE5AQHO_cjs.PluginBuilder({
  name: chunkQKE5AQHO_cjs.manifest_default.name,
  version: chunkQKE5AQHO_cjs.manifest_default.version,
  description: chunkQKE5AQHO_cjs.manifest_default.description,
  author: { name: chunkQKE5AQHO_cjs.manifest_default.author }
}).metadata({
  description: chunkQKE5AQHO_cjs.manifest_default.description,
  author: { name: chunkQKE5AQHO_cjs.manifest_default.author }
}).addService("turnstile", chunkQKE5AQHO_cjs.TurnstileService).addSingleMiddleware("verifyTurnstile", verifyTurnstile, {
...
//# sourceMappingURL=chunk-UICS6VT4.cjs.map
//# sourceMappingURL=chunk-UICS6VT4.cjs.map