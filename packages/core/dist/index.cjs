...
var chunkHELGMVPZ_cjs = require('./chunk-HELGMVPZ.cjs');
var chunkVNLR35GO_cjs = require('./chunk-VNLR35GO.cjs');
var chunk2PUBPBWX_cjs = require('./chunk-2PUBPBWX.cjs');
var chunkMPT5PA6U_cjs = require('./chunk-MPT5PA6U.cjs');
var chunkPG7RR6LW_cjs = require('./chunk-PG7RR6LW.cjs');
...
function createDatabaseToolsAdminRoutes() {
  ...
  router3.use("*", chunk2PUBPBWX_cjs.requireAuth());
...
function createOTPLoginPlugin() {
  ...
  otpAPI.post("/verify", async (c) => {
    try {
      ...
      const token = await chunk2PUBPBWX_cjs.AuthManager.generateToken(user.id, user.email, user.role);
    ...
    try {
      switch (rec.category) {
        case "synonym": {
          ...
          const synonymService = new chunkHELGMVPZ_cjs.SynonymService(this.db);
        ...
        case "query_rule": {
          ...
          const rulesService = new chunkHELGMVPZ_cjs.QueryRulesService(this.db);
...
adminRoutes.use("*", chunk2PUBPBWX_cjs.requireAuth());
adminRoutes.get("/", async (c) => {
  try {
    ...
    const service = new chunkHELGMVPZ_cjs.AISearchService(db, ai, vectorize, kv);
    const indexer = new chunkHELGMVPZ_cjs.IndexManager(db, ai, vectorize);
    const fts5Service = new chunkHELGMVPZ_cjs.FTS5Service(db);
    ...
    return c.html(
      chunkHELGMVPZ_cjs.renderSearchDashboard({
        settings,
...
adminRoutes.post("/", async (c) => {
  try {
    ...
    const ai = c.env.AI;
    const vectorize = c.env.VECTORIZE_INDEX;
    const service = new chunkHELGMVPZ_cjs.AISearchService(db, ai, vectorize);
    const indexer = new chunkHELGMVPZ_cjs.IndexManager(db, ai, vectorize);
    const body = await c.req.json();
...
adminRoutes.post("/api/vectorize/reindex-all", async (c) => {
  try {
    ...
    try {
      const benchmarkIds = [];
      for (const dsId of chunkHELGMVPZ_cjs.BENCHMARK_DATASETS.map((d) => d.id)) {
        for (let i = 0; i < 6e3; i++) {
...
adminRoutes.post("/api/relevance/preview", async (c) => {
  try {
    ...
    const service = new chunkHELGMVPZ_cjs.AISearchService(db);
    const settings = await service.getSettings();
    ...
    const pipelineService = new chunkHELGMVPZ_cjs.RankingPipelineService(db);
...
adminRoutes.get("/api/relevance/pipeline", async (c) => {
  try {
    const pipelineService = new chunkHELGMVPZ_cjs.RankingPipelineService(c.env.DB);
    const config = await pipelineService.getConfig();
...
adminRoutes.get("/api/relevance/synonyms", async (c) => {
  try {
    const synonymService = new chunkHELGMVPZ_cjs.SynonymService(c.env.DB);
...
adminRoutes.get("/api/relevance/rules", async (c) => {
  try {
    const rulesService = new chunkHELGMVPZ_cjs.QueryRulesService(c.env.DB);
...
adminRoutes.get("/api/related-searches", async (c) => {
  try {
    const service = new chunkHELGMVPZ_cjs.RelatedSearchService(c.env.DB, c.env.CACHE_KV);
...
adminRoutes.get("/api/facets/discover", async (c) => {
  try {
    const facetService = new chunkHELGMVPZ_cjs.FacetService(c.env.DB);
...
adminRoutes.get("/api/facets/config", async (c) => {
  try {
    const service = new chunkHELGMVPZ_cjs.AISearchService(c.env.DB);
    const settings = await service.getSettings();
...
adminRoutes.get("/api/benchmark/datasets", async (c) => {
  return c.json({ success: true, datasets: chunkHELGMVPZ_cjs.BENCHMARK_DATASETS });
});
adminRoutes.get("/api/benchmark/status", async (c) => {
  try {
    ...
    const benchmarkService = new chunkHELGMVPZ_cjs.BenchmarkService(db, kv, void 0, dataset);
...
adminRoutes.post("/api/benchmark/purge", async (c) => {
  try {
    ...
    const body = await c.req.json().catch(() => ({}));
    const dataset = body.dataset || "scifact";
    const benchmarkService = new chunkHELGMVPZ_cjs.BenchmarkService(db, kv, vectorize, dataset);
...
adminRoutes.post("/api/benchmark/index-vectorize-batch", async (c) => {
  try {
    ...
    const datasetInfo = chunkHELGMVPZ_cjs.BENCHMARK_DATASETS.find((d) => d.id === dataset);
    const displayName = datasetInfo ? `${datasetInfo.name} Benchmark` : `BEIR ${dataset} Benchmark`;
    const embeddingService = new chunkHELGMVPZ_cjs.EmbeddingService(ai);
    const chunkingService = new chunkHELGMVPZ_cjs.ChunkingService();
...
adminRoutes.post("/api/benchmark/evaluate", async (c) => {
  try {
    ...
    const aiSearchService = new chunkHELGMVPZ_cjs.AISearchService(db, ai, vectorize);
...
apiRoutes.get("/related", async (c) => {
  try {
    ...
    const service = new chunkHELGMVPZ_cjs.RelatedSearchService(db, kv);
...
apiRoutes.get("/trending", async (c) => {
  try {
    ...
    const service = new chunkHELGMVPZ_cjs.TrendingSearchService(db, kv);
...
instantSearchRoutes.post("/", async (c) => {
  try {
    ...
    const vectorize = c.env.VECTORIZE_INDEX;
    const kv = c.env.CACHE_KV;
    const searchService = new chunkHELGMVPZ_cjs.AISearchService(db, ai, vectorize, kv);
...
var aiSearchPlugin = new chunk6FHNRRJ3_cjs.PluginBuilder({
  ...
  description: manifest_default.description,
  author: { name: manifest_default.author }
}).addService("aiSearch", chunkHELGMVPZ_cjs.AISearchService).addService("indexManager", chunkHELGMVPZ_cjs.IndexManager).addRoute("/admin/plugins/ai-search", admin_default).addRoute("/api/search", api_default2).addRoute("/api/instantsearch", instantsearch_api_default).addRoute("/admin/plugins/ai-search", test_page_default).addRoute("/admin/plugins/ai-search", instantsearch_test_page_default).addRoute("/admin/plugins/ai-search", integration_guide_default).build();
...
function createMagicLinkAuthPlugin() {
  ...
  magicLinkRoutes.get("/verify", async (c) => {
    try {
      ...
      const jwtToken = await chunk2PUBPBWX_cjs.AuthManager.generateToken(
        user.id,
        user.email,
        user.role
      );
      chunk2PUBPBWX_cjs.AuthManager.setAuthCookie(c, jwtToken);
      await db.prepare(`
...
function renderCacheDashboard(data) {
  const pageContent = `
    ...
    ${chunkHELGMVPZ_cjs.renderConfirmationDialog({
    ...
    ${chunkHELGMVPZ_cjs.getConfirmationDialogScript()}
  `;
  const layoutData = {
    title: "Cache System",
...
function createSonicJSApp(config = {}) {
  ...
  app2.use("*", chunk2PUBPBWX_cjs.metricsMiddleware());
  app2.use("*", chunk2PUBPBWX_cjs.bootstrapMiddleware(config));
  ...
  app2.route("/api", chunkHELGMVPZ_cjs.api_default);
  app2.route("/api/media", chunkHELGMVPZ_cjs.api_media_default);
  app2.route("/api/system", chunkHELGMVPZ_cjs.api_system_default);
  app2.route("/admin/api", chunkHELGMVPZ_cjs.admin_api_default);
  app2.route("/admin/dashboard", chunkHELGMVPZ_cjs.router);
  app2.route("/admin/collections", chunkHELGMVPZ_cjs.adminCollectionsRoutes);
  app2.route("/admin/forms", chunkHELGMVPZ_cjs.adminFormsRoutes);
  app2.route("/admin/settings", chunkHELGMVPZ_cjs.adminSettingsRoutes);
  app2.route("/forms", chunkHELGMVPZ_cjs.public_forms_default);
  app2.route("/api/forms", chunkHELGMVPZ_cjs.public_forms_default);
  app2.route("/admin/api-reference", chunkHELGMVPZ_cjs.router2);
  app2.route("/admin/database-tools", createDatabaseToolsAdminRoutes());
  app2.route("/admin/seed-data", createSeedDataAdminRoutes());
  app2.route("/admin/content", chunkHELGMVPZ_cjs.admin_content_default);
  app2.route("/admin/media", chunkHELGMVPZ_cjs.adminMediaRoutes);
  app2.route("/admin/search", chunkHELGMVPZ_cjs.adminSearchRoutes);
  ...
  app2.route("/admin/plugins", chunkHELGMVPZ_cjs.adminPluginRoutes);
  app2.route("/admin/logs", chunkHELGMVPZ_cjs.adminLogsRoutes);
  app2.route("/admin", chunkHELGMVPZ_cjs.userRoutes);
  app2.route("/auth", chunkHELGMVPZ_cjs.auth_default);
  app2.route("/", chunkHELGMVPZ_cjs.test_cleanup_default);
...
Object.defineProperty(exports, "ROUTES_INFO", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.ROUTES_INFO; }
});
Object.defineProperty(exports, "adminApiRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.admin_api_default; }
});
Object.defineProperty(exports, "adminCheckboxRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.adminCheckboxRoutes; }
});
Object.defineProperty(exports, "adminCodeExamplesRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.admin_code_examples_default; }
});
Object.defineProperty(exports, "adminCollectionsRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.adminCollectionsRoutes; }
});
Object.defineProperty(exports, "adminContentRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.admin_content_default; }
});
Object.defineProperty(exports, "adminDashboardRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.router; }
});
Object.defineProperty(exports, "adminDesignRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.adminDesignRoutes; }
});
Object.defineProperty(exports, "adminLogsRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.adminLogsRoutes; }
});
Object.defineProperty(exports, "adminMediaRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.adminMediaRoutes; }
});
Object.defineProperty(exports, "adminPluginRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.adminPluginRoutes; }
});
Object.defineProperty(exports, "adminSettingsRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.adminSettingsRoutes; }
});
Object.defineProperty(exports, "adminTestimonialsRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.admin_testimonials_default; }
});
Object.defineProperty(exports, "adminUsersRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.userRoutes; }
});
Object.defineProperty(exports, "apiContentCrudRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.api_content_crud_default; }
});
Object.defineProperty(exports, "apiMediaRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.api_media_default; }
});
Object.defineProperty(exports, "apiRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.api_default; }
});
Object.defineProperty(exports, "apiSystemRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.api_system_default; }
});
Object.defineProperty(exports, "authRoutes", {
  enumerable: true,
  get: function () { return chunkHELGMVPZ_cjs.auth_default; }
});
...
Object.defineProperty(exports, "AuthManager", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.AuthManager; }
});
Object.defineProperty(exports, "PermissionManager", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.PermissionManager; }
});
Object.defineProperty(exports, "bootstrapMiddleware", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.bootstrapMiddleware; }
});
Object.defineProperty(exports, "cacheHeaders", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.cacheHeaders; }
});
Object.defineProperty(exports, "compressionMiddleware", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.compressionMiddleware; }
});
Object.defineProperty(exports, "detailedLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.detailedLoggingMiddleware; }
});
Object.defineProperty(exports, "getActivePlugins", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.getActivePlugins; }
});
Object.defineProperty(exports, "isPluginActive", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.isPluginActive; }
});
Object.defineProperty(exports, "logActivity", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.logActivity; }
});
Object.defineProperty(exports, "loggingMiddleware", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.loggingMiddleware; }
});
Object.defineProperty(exports, "optionalAuth", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.optionalAuth; }
});
Object.defineProperty(exports, "performanceLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.performanceLoggingMiddleware; }
});
Object.defineProperty(exports, "requireActivePlugin", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.requireActivePlugin; }
});
Object.defineProperty(exports, "requireActivePlugins", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.requireActivePlugins; }
});
Object.defineProperty(exports, "requireAnyPermission", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.requireAnyPermission; }
});
Object.defineProperty(exports, "requireAuth", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.requireAuth; }
});
Object.defineProperty(exports, "requirePermission", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.requirePermission; }
});
Object.defineProperty(exports, "requireRole", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.requireRole; }
});
Object.defineProperty(exports, "securityHeaders", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.securityHeaders; }
});
Object.defineProperty(exports, "securityLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunk2PUBPBWX_cjs.securityLoggingMiddleware; }
});
...
Object.defineProperty(exports, "MigrationService", {
  enumerable: true,
  get: function () { return chunkPG7RR6LW_cjs.MigrationService; }
});
