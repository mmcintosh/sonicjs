...
var chunkLRGVLBMZ_cjs = require('./chunk-LRGVLBMZ.cjs');
...
function createDatabaseToolsAdminRoutes() {
  ...
  router3.use("*", chunkKKOBMGNI_cjs.requireAuth());
    ...
    try {
      switch (rec.category) {
        case "synonym": {
          ...
          const synonymService = new chunkLRGVLBMZ_cjs.SynonymService(this.db);
        ...
        case "query_rule": {
          ...
          const rulesService = new chunkLRGVLBMZ_cjs.QueryRulesService(this.db);
...
adminRoutes.use("*", chunkKKOBMGNI_cjs.requireAuth());
adminRoutes.get("/", async (c) => {
  try {
    ...
    const service = new chunkLRGVLBMZ_cjs.AISearchService(db, ai, vectorize, kv);
    const indexer = new chunkLRGVLBMZ_cjs.IndexManager(db, ai, vectorize);
    const fts5Service = new chunkLRGVLBMZ_cjs.FTS5Service(db);
    let settings = null;
    try {
    ...
    return c.html(
      chunkLRGVLBMZ_cjs.renderSearchDashboard({
        settings,
...
adminRoutes.post("/", async (c) => {
  try {
    ...
    const ai = c.env.AI;
    const vectorize = c.env.VECTORIZE_INDEX;
    const service = new chunkLRGVLBMZ_cjs.AISearchService(db, ai, vectorize);
    const indexer = new chunkLRGVLBMZ_cjs.IndexManager(db, ai, vectorize);
    const body = await c.req.json();
...
adminRoutes.post("/api/vectorize/reindex-all", async (c) => {
  try {
    ...
    try {
      const benchmarkIds = [];
      for (const dsId of chunkLRGVLBMZ_cjs.BENCHMARK_DATASETS.map((d) => d.id)) {
        for (let i = 0; i < 6e3; i++) {
...
adminRoutes.post("/api/relevance/preview", async (c) => {
  try {
    ...
    const service = new chunkLRGVLBMZ_cjs.AISearchService(db);
    const settings = await service.getSettings();
    ...
    const pipelineService = new chunkLRGVLBMZ_cjs.RankingPipelineService(db);
...
adminRoutes.get("/api/relevance/pipeline", async (c) => {
  try {
    const pipelineService = new chunkLRGVLBMZ_cjs.RankingPipelineService(c.env.DB);
    const config = await pipelineService.getConfig();
...
adminRoutes.get("/api/relevance/synonyms", async (c) => {
  try {
    const synonymService = new chunkLRGVLBMZ_cjs.SynonymService(c.env.DB);
...
adminRoutes.get("/api/relevance/rules", async (c) => {
  try {
    const rulesService = new chunkLRGVLBMZ_cjs.QueryRulesService(c.env.DB);
...
adminRoutes.get("/api/related-searches", async (c) => {
  try {
    const service = new chunkLRGVLBMZ_cjs.RelatedSearchService(c.env.DB, c.env.CACHE_KV);
...
adminRoutes.get("/api/facets/discover", async (c) => {
  try {
    const facetService = new chunkLRGVLBMZ_cjs.FacetService(c.env.DB);
...
adminRoutes.get("/api/facets/config", async (c) => {
  try {
    const service = new chunkLRGVLBMZ_cjs.AISearchService(c.env.DB);
    const settings = await service.getSettings();
...
adminRoutes.get("/api/benchmark/datasets", async (c) => {
  return c.json({ success: true, datasets: chunkLRGVLBMZ_cjs.BENCHMARK_DATASETS });
});
adminRoutes.get("/api/benchmark/status", async (c) => {
  try {
    ...
    const benchmarkService = new chunkLRGVLBMZ_cjs.BenchmarkService(db, kv, void 0, dataset);
...
adminRoutes.post("/api/benchmark/purge", async (c) => {
  try {
    ...
    const body = await c.req.json().catch(() => ({}));
    const dataset = body.dataset || "scifact";
    const benchmarkService = new chunkLRGVLBMZ_cjs.BenchmarkService(db, kv, vectorize, dataset);
...
adminRoutes.post("/api/benchmark/index-vectorize-batch", async (c) => {
  try {
    ...
    const datasetInfo = chunkLRGVLBMZ_cjs.BENCHMARK_DATASETS.find((d) => d.id === dataset);
    const displayName = datasetInfo ? `${datasetInfo.name} Benchmark` : `BEIR ${dataset} Benchmark`;
    const embeddingService = new chunkLRGVLBMZ_cjs.EmbeddingService(ai);
    const chunkingService = new chunkLRGVLBMZ_cjs.ChunkingService();
...
adminRoutes.post("/api/benchmark/evaluate", async (c) => {
  try {
    ...
    const aiSearchService = new chunkLRGVLBMZ_cjs.AISearchService(db, ai, vectorize);
...
apiRoutes.use("*", chunkKKOBMGNI_cjs.optionalAuth());
apiRoutes.use("*", chunkKKOBMGNI_cjs.optionalApiKey());
...
apiRoutes.get("/related", async (c) => {
  try {
    ...
    const service = new chunkLRGVLBMZ_cjs.RelatedSearchService(db, kv);
...
apiRoutes.get("/trending", async (c) => {
  try {
    ...
    const service = new chunkLRGVLBMZ_cjs.TrendingSearchService(db, kv);
...
instantSearchRoutes.post("/", async (c) => {
  try {
    ...
    const vectorize = c.env.VECTORIZE_INDEX;
    const kv = c.env.CACHE_KV;
    const searchService = new chunkLRGVLBMZ_cjs.AISearchService(db, ai, vectorize, kv);
...
function createMagicLinkAuthPlugin() {
  ...
  magicLinkRoutes.get("/verify", async (c) => {
    try {
      ...
      const jwtToken = await chunkKKOBMGNI_cjs.AuthManager.generateToken(
        user.id,
        user.email,
        user.role
      );
      chunkKKOBMGNI_cjs.AuthManager.setAuthCookie(c, jwtToken);
      await db.prepare(`
...
function renderCacheDashboard(data) {
  const pageContent = `
    ...
    ${chunkLRGVLBMZ_cjs.renderConfirmationDialog({
    ...
    ${chunkLRGVLBMZ_cjs.getConfirmationDialogScript()}
  `;
  const layoutData = {
    title: "Cache System",
...
function createSonicJSApp(config = {}) {
  ...
  app2.use("*", chunkKKOBMGNI_cjs.metricsMiddleware());
  app2.use("*", chunkKKOBMGNI_cjs.bootstrapMiddleware(config));
  ...
  app2.route("/api", chunkLRGVLBMZ_cjs.api_default);
  app2.route("/api/media", chunkLRGVLBMZ_cjs.api_media_default);
  app2.route("/api/system", chunkLRGVLBMZ_cjs.api_system_default);
  app2.route("/admin/api", chunkLRGVLBMZ_cjs.admin_api_default);
  app2.route("/admin/dashboard", chunkLRGVLBMZ_cjs.router);
  app2.route("/admin/collections", chunkLRGVLBMZ_cjs.adminCollectionsRoutes);
  app2.route("/admin/forms", chunkLRGVLBMZ_cjs.adminFormsRoutes);
  app2.route("/admin/settings", chunkLRGVLBMZ_cjs.adminSettingsRoutes);
  app2.route("/forms", chunkLRGVLBMZ_cjs.public_forms_default);
  app2.route("/api/forms", chunkLRGVLBMZ_cjs.public_forms_default);
  app2.route("/admin/api-reference", chunkLRGVLBMZ_cjs.router2);
  app2.route("/admin/database-tools", createDatabaseToolsAdminRoutes());
  app2.route("/admin/seed-data", createSeedDataAdminRoutes());
  app2.route("/admin/content", chunkLRGVLBMZ_cjs.admin_content_default);
  app2.route("/admin/media", chunkLRGVLBMZ_cjs.adminMediaRoutes);
  app2.route("/admin/search", chunkLRGVLBMZ_cjs.adminSearchRoutes);
  app2.route("/admin/api-keys", chunkLRGVLBMZ_cjs.adminApiKeyRoutes);
  ...
  app2.route("/admin/plugins", chunkLRGVLBMZ_cjs.adminPluginRoutes);
  app2.route("/admin/logs", chunkLRGVLBMZ_cjs.adminLogsRoutes);
  app2.route("/admin", chunkLRGVLBMZ_cjs.userRoutes);
  app2.route("/auth", chunkLRGVLBMZ_cjs.auth_default);
  app2.route("/", chunkLRGVLBMZ_cjs.test_cleanup_default);
...
Object.defineProperty(exports, "ROUTES_INFO", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.ROUTES_INFO; }
});
Object.defineProperty(exports, "adminApiRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.admin_api_default; }
});
Object.defineProperty(exports, "adminCheckboxRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.adminCheckboxRoutes; }
});
Object.defineProperty(exports, "adminCodeExamplesRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.admin_code_examples_default; }
});
Object.defineProperty(exports, "adminCollectionsRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.adminCollectionsRoutes; }
});
Object.defineProperty(exports, "adminContentRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.admin_content_default; }
});
Object.defineProperty(exports, "adminDashboardRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.router; }
});
Object.defineProperty(exports, "adminDesignRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.adminDesignRoutes; }
});
Object.defineProperty(exports, "adminLogsRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.adminLogsRoutes; }
});
Object.defineProperty(exports, "adminMediaRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.adminMediaRoutes; }
});
Object.defineProperty(exports, "adminPluginRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.adminPluginRoutes; }
});
Object.defineProperty(exports, "adminSettingsRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.adminSettingsRoutes; }
});
Object.defineProperty(exports, "adminTestimonialsRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.admin_testimonials_default; }
});
Object.defineProperty(exports, "adminUsersRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.userRoutes; }
});
Object.defineProperty(exports, "apiContentCrudRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.api_content_crud_default; }
});
Object.defineProperty(exports, "apiMediaRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.api_media_default; }
});
Object.defineProperty(exports, "apiRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.api_default; }
});
Object.defineProperty(exports, "apiSystemRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.api_system_default; }
});
Object.defineProperty(exports, "authRoutes", {
  enumerable: true,
  get: function () { return chunkLRGVLBMZ_cjs.auth_default; }
});
...
Object.defineProperty(exports, "AuthManager", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.AuthManager; }
});
Object.defineProperty(exports, "PermissionManager", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.PermissionManager; }
});
Object.defineProperty(exports, "bootstrapMiddleware", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.bootstrapMiddleware; }
});
Object.defineProperty(exports, "cacheHeaders", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.cacheHeaders; }
});
Object.defineProperty(exports, "compressionMiddleware", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.compressionMiddleware; }
});
Object.defineProperty(exports, "detailedLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.detailedLoggingMiddleware; }
});
Object.defineProperty(exports, "getActivePlugins", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.getActivePlugins; }
});
Object.defineProperty(exports, "isPluginActive", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.isPluginActive; }
});
Object.defineProperty(exports, "logActivity", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.logActivity; }
});
Object.defineProperty(exports, "loggingMiddleware", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.loggingMiddleware; }
});
Object.defineProperty(exports, "optionalAuth", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.optionalAuth; }
});
Object.defineProperty(exports, "performanceLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.performanceLoggingMiddleware; }
});
Object.defineProperty(exports, "requireActivePlugin", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.requireActivePlugin; }
});
Object.defineProperty(exports, "requireActivePlugins", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.requireActivePlugins; }
});
Object.defineProperty(exports, "requireAnyPermission", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.requireAnyPermission; }
});
Object.defineProperty(exports, "requireAuth", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.requireAuth; }
});
Object.defineProperty(exports, "requirePermission", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.requirePermission; }
});
Object.defineProperty(exports, "requireRole", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.requireRole; }
});
Object.defineProperty(exports, "securityHeaders", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.securityHeaders; }
});
Object.defineProperty(exports, "securityLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkKKOBMGNI_cjs.securityLoggingMiddleware; }
});
...
Object.defineProperty(exports, "MigrationService", {
  enumerable: true,
  get: function () { return chunkFEIK7JC2_cjs.MigrationService; }
});
