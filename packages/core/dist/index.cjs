...
var chunkD5O4LHFR_cjs = require('./chunk-D5O4LHFR.cjs');
var chunk64APW3DW_cjs = require('./chunk-64APW3DW.cjs');
var chunkAXBWCVWC_cjs = require('./chunk-AXBWCVWC.cjs');
...
function createDatabaseToolsAdminRoutes() {
  ...
  router3.use("*", chunkAXBWCVWC_cjs.requireAuth());
...
function createOTPLoginPlugin() {
  ...
  otpAPI.post("/verify", async (c) => {
    try {
      ...
      const token = await chunkAXBWCVWC_cjs.AuthManager.generateToken(user.id, user.email, user.role, c.env.JWT_SECRET);
    ...
    try {
      switch (rec.category) {
        case "synonym": {
          ...
          const synonymService = new chunkD5O4LHFR_cjs.SynonymService(this.db);
        ...
        case "query_rule": {
          ...
          const rulesService = new chunkD5O4LHFR_cjs.QueryRulesService(this.db);
        ...
        case "related_search": {
          ...
          const relatedService = new chunkD5O4LHFR_cjs.RelatedSearchService(this.db);
...
adminRoutes.use("*", chunkAXBWCVWC_cjs.requireAuth());
adminRoutes.get("/", async (c) => {
  try {
    ...
    const service = new chunkD5O4LHFR_cjs.AISearchService(db, ai, vectorize, kv);
    const indexer = new chunkD5O4LHFR_cjs.IndexManager(db, ai, vectorize);
    const fts5Service = new chunkD5O4LHFR_cjs.FTS5Service(db);
    let settings = null;
    try {
    ...
    return c.html(
      chunkD5O4LHFR_cjs.renderSearchDashboard({
        settings,
...
adminRoutes.post("/", async (c) => {
  try {
    ...
    const ai = c.env.AI;
    const vectorize = c.env.VECTORIZE_INDEX;
    const service = new chunkD5O4LHFR_cjs.AISearchService(db, ai, vectorize);
    const indexer = new chunkD5O4LHFR_cjs.IndexManager(db, ai, vectorize);
    const body = await c.req.json();
...
adminRoutes.post("/api/vectorize/reindex-all", async (c) => {
  try {
    ...
    try {
      const benchmarkIds = [];
      for (const dsId of chunkD5O4LHFR_cjs.BENCHMARK_DATASETS.map((d) => d.id)) {
        for (let i = 0; i < 6e3; i++) {
...
adminRoutes.post("/api/relevance/preview", async (c) => {
  try {
    ...
    const service = new chunkD5O4LHFR_cjs.AISearchService(db);
    const settings = await service.getSettings();
    ...
    const pipelineService = new chunkD5O4LHFR_cjs.RankingPipelineService(db);
...
adminRoutes.get("/api/relevance/pipeline", async (c) => {
  try {
    const pipelineService = new chunkD5O4LHFR_cjs.RankingPipelineService(c.env.DB);
    const config = await pipelineService.getConfig();
...
adminRoutes.get("/api/relevance/synonyms", async (c) => {
  try {
    const synonymService = new chunkD5O4LHFR_cjs.SynonymService(c.env.DB);
...
adminRoutes.get("/api/relevance/rules", async (c) => {
  try {
    const rulesService = new chunkD5O4LHFR_cjs.QueryRulesService(c.env.DB);
...
adminRoutes.get("/api/related-searches", async (c) => {
  try {
    const service = new chunkD5O4LHFR_cjs.RelatedSearchService(c.env.DB, c.env.CACHE_KV);
...
adminRoutes.get("/api/facets/discover", async (c) => {
  try {
    const facetService = new chunkD5O4LHFR_cjs.FacetService(c.env.DB);
...
adminRoutes.get("/api/facets/config", async (c) => {
  try {
    const service = new chunkD5O4LHFR_cjs.AISearchService(c.env.DB);
    const settings = await service.getSettings();
...
adminRoutes.get("/api/benchmark/datasets", async (c) => {
  return c.json({ success: true, datasets: chunkD5O4LHFR_cjs.BENCHMARK_DATASETS });
});
adminRoutes.get("/api/benchmark/status", async (c) => {
  try {
    ...
    const benchmarkService = new chunkD5O4LHFR_cjs.BenchmarkService(db, kv, void 0, dataset);
...
adminRoutes.post("/api/benchmark/purge", async (c) => {
  try {
    ...
    const body = await c.req.json().catch(() => ({}));
    const dataset = body.dataset || "scifact";
    const benchmarkService = new chunkD5O4LHFR_cjs.BenchmarkService(db, kv, vectorize, dataset);
...
adminRoutes.post("/api/benchmark/index-vectorize-batch", async (c) => {
  try {
    ...
    const datasetInfo = chunkD5O4LHFR_cjs.BENCHMARK_DATASETS.find((d) => d.id === dataset);
    const displayName = datasetInfo ? `${datasetInfo.name} Benchmark` : `BEIR ${dataset} Benchmark`;
    const embeddingService = new chunkD5O4LHFR_cjs.EmbeddingService(ai);
    const chunkingService = new chunkD5O4LHFR_cjs.ChunkingService();
...
adminRoutes.post("/api/benchmark/evaluate", async (c) => {
  try {
    ...
    const aiSearchService = new chunkD5O4LHFR_cjs.AISearchService(db, ai, vectorize);
...
apiRoutes.use("*", chunkAXBWCVWC_cjs.optionalAuth());
apiRoutes.use("*", chunkAXBWCVWC_cjs.optionalApiKey());
...
apiRoutes.get("/related", async (c) => {
  try {
    ...
    const service = new chunkD5O4LHFR_cjs.RelatedSearchService(db, kv);
...
apiRoutes.get("/trending", async (c) => {
  try {
    ...
    const service = new chunkD5O4LHFR_cjs.TrendingSearchService(db, kv);
...
instantSearchRoutes.post("/", async (c) => {
  try {
    ...
    const vectorize = c.env.VECTORIZE_INDEX;
    const kv = c.env.CACHE_KV;
    const searchService = new chunkD5O4LHFR_cjs.AISearchService(db, ai, vectorize, kv);
...
var aiSearchPlugin = new chunk6FHNRRJ3_cjs.PluginBuilder({
  ...
  description: manifest_default.description,
  author: { name: manifest_default.author }
}).addService("aiSearch", chunkD5O4LHFR_cjs.AISearchService).addService("indexManager", chunkD5O4LHFR_cjs.IndexManager).addRoute("/admin/plugins/ai-search", admin_default).addRoute("/api/search", api_default2).addRoute("/api/instantsearch", instantsearch_api_default).addRoute("/admin/plugins/ai-search", test_page_default).addRoute("/admin/plugins/ai-search", instantsearch_test_page_default).addRoute("/admin/plugins/ai-search", integration_guide_default).addRoute("/admin/plugins/ai-search", documentation_default).build();
...
function createMagicLinkAuthPlugin() {
  ...
  magicLinkRoutes.get("/verify", async (c) => {
    try {
      ...
      const jwtToken = await chunkAXBWCVWC_cjs.AuthManager.generateToken(
        user.id,
        user.email,
        user.role,
        c.env.JWT_SECRET
      );
      chunkAXBWCVWC_cjs.AuthManager.setAuthCookie(c, jwtToken);
      await db.prepare(`
...
function renderCacheDashboard(data) {
  const pageContent = `
    ...
    ${chunkD5O4LHFR_cjs.renderConfirmationDialog({
    ...
    ${chunkD5O4LHFR_cjs.getConfirmationDialogScript()}
  `;
  const layoutData = {
    title: "Cache System",
...
function createSonicJSApp(config = {}) {
  ...
  app2.use("*", chunkAXBWCVWC_cjs.metricsMiddleware());
  app2.use("*", chunkAXBWCVWC_cjs.bootstrapMiddleware(config));
  ...
  app2.route("/api", chunkD5O4LHFR_cjs.api_default);
  app2.route("/api/media", chunkD5O4LHFR_cjs.api_media_default);
  app2.route("/api/system", chunkD5O4LHFR_cjs.api_system_default);
  app2.route("/admin/api", chunkD5O4LHFR_cjs.admin_api_default);
  app2.route("/admin/dashboard", chunkD5O4LHFR_cjs.router);
  app2.route("/admin/collections", chunkD5O4LHFR_cjs.adminCollectionsRoutes);
  app2.route("/admin/forms", chunkD5O4LHFR_cjs.adminFormsRoutes);
  app2.route("/admin/settings", chunkD5O4LHFR_cjs.adminSettingsRoutes);
  app2.route("/forms", chunkD5O4LHFR_cjs.public_forms_default);
  app2.route("/api/forms", chunkD5O4LHFR_cjs.public_forms_default);
  app2.route("/admin/api-reference", chunkD5O4LHFR_cjs.router2);
  app2.route("/admin/database-tools", createDatabaseToolsAdminRoutes());
  app2.route("/admin/seed-data", createSeedDataAdminRoutes());
  app2.route("/admin/content", chunkD5O4LHFR_cjs.admin_content_default);
  app2.route("/admin/media", chunkD5O4LHFR_cjs.adminMediaRoutes);
  app2.route("/admin/search", chunkD5O4LHFR_cjs.adminSearchRoutes);
  app2.route("/admin/api-keys", chunkD5O4LHFR_cjs.adminApiKeyRoutes);
  ...
  app2.route("/admin/plugins", chunkD5O4LHFR_cjs.adminPluginRoutes);
  app2.route("/admin/logs", chunkD5O4LHFR_cjs.adminLogsRoutes);
  app2.route("/admin", chunkD5O4LHFR_cjs.userRoutes);
  app2.route("/auth", chunkD5O4LHFR_cjs.auth_default);
  app2.route("/", chunkD5O4LHFR_cjs.test_cleanup_default);
...
Object.defineProperty(exports, "ROUTES_INFO", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.ROUTES_INFO; }
});
Object.defineProperty(exports, "adminApiRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.admin_api_default; }
});
Object.defineProperty(exports, "adminCheckboxRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.adminCheckboxRoutes; }
});
Object.defineProperty(exports, "adminCodeExamplesRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.admin_code_examples_default; }
});
Object.defineProperty(exports, "adminCollectionsRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.adminCollectionsRoutes; }
});
Object.defineProperty(exports, "adminContentRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.admin_content_default; }
});
Object.defineProperty(exports, "adminDashboardRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.router; }
});
Object.defineProperty(exports, "adminDesignRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.adminDesignRoutes; }
});
Object.defineProperty(exports, "adminLogsRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.adminLogsRoutes; }
});
Object.defineProperty(exports, "adminMediaRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.adminMediaRoutes; }
});
Object.defineProperty(exports, "adminPluginRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.adminPluginRoutes; }
});
Object.defineProperty(exports, "adminSettingsRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.adminSettingsRoutes; }
});
Object.defineProperty(exports, "adminTestimonialsRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.admin_testimonials_default; }
});
Object.defineProperty(exports, "adminUsersRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.userRoutes; }
});
Object.defineProperty(exports, "apiContentCrudRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.api_content_crud_default; }
});
Object.defineProperty(exports, "apiMediaRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.api_media_default; }
});
Object.defineProperty(exports, "apiRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.api_default; }
});
Object.defineProperty(exports, "apiSystemRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.api_system_default; }
});
Object.defineProperty(exports, "authRoutes", {
  enumerable: true,
  get: function () { return chunkD5O4LHFR_cjs.auth_default; }
});
...
Object.defineProperty(exports, "AuthManager", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.AuthManager; }
});
Object.defineProperty(exports, "PermissionManager", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.PermissionManager; }
});
Object.defineProperty(exports, "bootstrapMiddleware", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.bootstrapMiddleware; }
});
Object.defineProperty(exports, "cacheHeaders", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.cacheHeaders; }
});
Object.defineProperty(exports, "compressionMiddleware", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.compressionMiddleware; }
});
Object.defineProperty(exports, "detailedLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.detailedLoggingMiddleware; }
});
Object.defineProperty(exports, "getActivePlugins", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.getActivePlugins; }
});
Object.defineProperty(exports, "isPluginActive", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.isPluginActive; }
});
Object.defineProperty(exports, "logActivity", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.logActivity; }
});
Object.defineProperty(exports, "loggingMiddleware", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.loggingMiddleware; }
});
Object.defineProperty(exports, "optionalAuth", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.optionalAuth; }
});
Object.defineProperty(exports, "performanceLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.performanceLoggingMiddleware; }
});
Object.defineProperty(exports, "requireActivePlugin", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.requireActivePlugin; }
});
Object.defineProperty(exports, "requireActivePlugins", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.requireActivePlugins; }
});
Object.defineProperty(exports, "requireAnyPermission", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.requireAnyPermission; }
});
Object.defineProperty(exports, "requireAuth", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.requireAuth; }
});
Object.defineProperty(exports, "requirePermission", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.requirePermission; }
});
Object.defineProperty(exports, "requireRole", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.requireRole; }
});
Object.defineProperty(exports, "securityHeaders", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.securityHeaders; }
});
Object.defineProperty(exports, "securityLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkAXBWCVWC_cjs.securityLoggingMiddleware; }
});
...
Object.defineProperty(exports, "MigrationService", {
  enumerable: true,
  get: function () { return chunkTSF47PIE_cjs.MigrationService; }
});
