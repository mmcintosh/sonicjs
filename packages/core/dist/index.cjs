...
var chunkBGVZL6KN_cjs = require('./chunk-BGVZL6KN.cjs');
var chunkDY3PXZ7R_cjs = require('./chunk-DY3PXZ7R.cjs');
var chunkWUZRX5SW_cjs = require('./chunk-WUZRX5SW.cjs');
var chunkUS6ANQDX_cjs = require('./chunk-US6ANQDX.cjs');
var chunk77JM55RB_cjs = require('./chunk-77JM55RB.cjs');
...
function createDatabaseToolsAdminRoutes() {
  ...
  router4.use("*", chunkWUZRX5SW_cjs.requireAuth());
...
function createOTPLoginPlugin() {
  ...
  otpAPI.post("/verify", async (c) => {
    try {
      ...
      const token = await chunkWUZRX5SW_cjs.AuthManager.generateToken(user.id, user.email, user.role, c.env.JWT_SECRET);
    ...
    try {
      switch (rec.category) {
        case "synonym": {
          ...
          const synonymService = new chunkBGVZL6KN_cjs.SynonymService(this.db);
        ...
        case "query_rule": {
          ...
          const rulesService = new chunkBGVZL6KN_cjs.QueryRulesService(this.db);
        ...
        case "related_search": {
          ...
          const relatedService = new chunkBGVZL6KN_cjs.RelatedSearchService(this.db);
...
adminRoutes.use("*", chunkWUZRX5SW_cjs.requireAuth());
adminRoutes.get("/", async (c) => {
  try {
    ...
    const service = new chunkBGVZL6KN_cjs.AISearchService(db, ai, vectorize, kv);
    const indexer = new chunkBGVZL6KN_cjs.IndexManager(db, ai, vectorize);
    const fts5Service = new chunkBGVZL6KN_cjs.FTS5Service(db);
    let settings = null;
    try {
    ...
    return c.html(
      chunkBGVZL6KN_cjs.renderSearchDashboard({
        settings,
...
adminRoutes.post("/", async (c) => {
  try {
    ...
    const ai = c.env.AI;
    const vectorize = c.env.VECTORIZE_INDEX;
    const service = new chunkBGVZL6KN_cjs.AISearchService(db, ai, vectorize);
    const indexer = new chunkBGVZL6KN_cjs.IndexManager(db, ai, vectorize);
    const body = await c.req.json();
...
adminRoutes.post("/api/vectorize/reindex-all", async (c) => {
  try {
    ...
    try {
      const benchmarkIds = [];
      for (const dsId of chunkBGVZL6KN_cjs.BENCHMARK_DATASETS.map((d) => d.id)) {
        for (let i = 0; i < 6e3; i++) {
...
adminRoutes.post("/api/relevance/preview", async (c) => {
  try {
    ...
    const service = new chunkBGVZL6KN_cjs.AISearchService(db);
    const settings = await service.getSettings();
    ...
    const pipelineService = new chunkBGVZL6KN_cjs.RankingPipelineService(db);
...
adminRoutes.get("/api/relevance/pipeline", async (c) => {
  try {
    const pipelineService = new chunkBGVZL6KN_cjs.RankingPipelineService(c.env.DB);
    const config = await pipelineService.getConfig();
...
adminRoutes.get("/api/relevance/synonyms", async (c) => {
  try {
    const synonymService = new chunkBGVZL6KN_cjs.SynonymService(c.env.DB);
...
adminRoutes.get("/api/relevance/rules", async (c) => {
  try {
    const rulesService = new chunkBGVZL6KN_cjs.QueryRulesService(c.env.DB);
...
adminRoutes.get("/api/related-searches", async (c) => {
  try {
    const service = new chunkBGVZL6KN_cjs.RelatedSearchService(c.env.DB, c.env.CACHE_KV);
...
adminRoutes.get("/api/facets/discover", async (c) => {
  try {
    const facetService = new chunkBGVZL6KN_cjs.FacetService(c.env.DB);
...
adminRoutes.get("/api/facets/config", async (c) => {
  try {
    const service = new chunkBGVZL6KN_cjs.AISearchService(c.env.DB);
    const settings = await service.getSettings();
...
adminRoutes.get("/api/benchmark/datasets", async (c) => {
  return c.json({ success: true, datasets: chunkBGVZL6KN_cjs.BENCHMARK_DATASETS });
});
adminRoutes.get("/api/benchmark/status", async (c) => {
  try {
    ...
    const benchmarkService = new chunkBGVZL6KN_cjs.BenchmarkService(db, kv, void 0, dataset);
...
adminRoutes.post("/api/benchmark/purge", async (c) => {
  try {
    ...
    const body = await c.req.json().catch(() => ({}));
    const dataset = body.dataset || "scifact";
    const benchmarkService = new chunkBGVZL6KN_cjs.BenchmarkService(db, kv, vectorize, dataset);
...
adminRoutes.post("/api/benchmark/index-vectorize-batch", async (c) => {
  try {
    ...
    const datasetInfo = chunkBGVZL6KN_cjs.BENCHMARK_DATASETS.find((d) => d.id === dataset);
    const displayName = datasetInfo ? `${datasetInfo.name} Benchmark` : `BEIR ${dataset} Benchmark`;
    const embeddingService = new chunkBGVZL6KN_cjs.EmbeddingService(ai);
    const chunkingService = new chunkBGVZL6KN_cjs.ChunkingService();
...
adminRoutes.post("/api/benchmark/evaluate", async (c) => {
  try {
    ...
    const aiSearchService = new chunkBGVZL6KN_cjs.AISearchService(db, ai, vectorize);
...
apiRoutes.use("*", chunkWUZRX5SW_cjs.optionalAuth());
apiRoutes.use("*", chunkWUZRX5SW_cjs.optionalApiKey());
...
apiRoutes.get("/related", async (c) => {
  try {
    ...
    const service = new chunkBGVZL6KN_cjs.RelatedSearchService(db, kv);
...
apiRoutes.get("/trending", async (c) => {
  try {
    ...
    const service = new chunkBGVZL6KN_cjs.TrendingSearchService(db, kv);
...
instantSearchRoutes.post("/", async (c) => {
  try {
    ...
    const vectorize = c.env.VECTORIZE_INDEX;
    const kv = c.env.CACHE_KV;
    const searchService = new chunkBGVZL6KN_cjs.AISearchService(db, ai, vectorize, kv);
...
var aiSearchPlugin = new chunkQKE5AQHO_cjs.PluginBuilder({
  ...
  description: manifest_default.description,
  author: { name: manifest_default.author }
}).addService("aiSearch", chunkBGVZL6KN_cjs.AISearchService).addService("indexManager", chunkBGVZL6KN_cjs.IndexManager).addRoute("/admin/plugins/ai-search", admin_default).addRoute("/api/search", api_default2).addRoute("/api/instantsearch", instantsearch_api_default).addRoute("/admin/plugins/ai-search", test_page_default).addRoute("/admin/plugins/ai-search", instantsearch_test_page_default).addRoute("/admin/plugins/ai-search", integration_guide_default).addRoute("/admin/plugins/ai-search", documentation_default).build();
...
function createMagicLinkAuthPlugin() {
  ...
  magicLinkRoutes.get("/verify", async (c) => {
    try {
      ...
      const jwtToken = await chunkWUZRX5SW_cjs.AuthManager.generateToken(
        user.id,
        user.email,
        user.role,
        c.env.JWT_SECRET
      );
      chunkWUZRX5SW_cjs.AuthManager.setAuthCookie(c, jwtToken);
      await db.prepare(`
...
function renderCacheDashboard(data) {
  const pageContent = `
    ...
    ${chunkBGVZL6KN_cjs.renderConfirmationDialog({
    ...
    ${chunkBGVZL6KN_cjs.getConfirmationDialogScript()}
  `;
  const layoutData = {
    title: "Cache System",
...
function createSonicJSApp(config = {}) {
  ...
  app2.use("*", chunkWUZRX5SW_cjs.metricsMiddleware());
  app2.use("*", chunkWUZRX5SW_cjs.bootstrapMiddleware(config));
  ...
  app2.use("*", chunkWUZRX5SW_cjs.securityHeadersMiddleware());
  app2.use("*", chunkWUZRX5SW_cjs.csrfProtection());
  if (config.middleware?.afterAuth) {
    for (const middleware of config.middleware.afterAuth) {
      app2.use("*", middleware);
    }
  }
  app2.route("/api", chunkBGVZL6KN_cjs.api_default);
  app2.route("/api/media", chunkBGVZL6KN_cjs.api_media_default);
  app2.route("/api/system", chunkBGVZL6KN_cjs.api_system_default);
  app2.route("/admin/api", chunkBGVZL6KN_cjs.admin_api_default);
  app2.route("/admin/dashboard", chunkBGVZL6KN_cjs.router);
  app2.route("/admin/collections", chunkBGVZL6KN_cjs.adminCollectionsRoutes);
  app2.route("/admin/forms", chunkBGVZL6KN_cjs.adminFormsRoutes);
  app2.route("/admin/settings", chunkBGVZL6KN_cjs.adminSettingsRoutes);
  app2.route("/forms", chunkBGVZL6KN_cjs.public_forms_default);
  app2.route("/api/forms", chunkBGVZL6KN_cjs.public_forms_default);
  app2.route("/admin/api-reference", chunkBGVZL6KN_cjs.router2);
  app2.route("/admin/api-docs", chunkBGVZL6KN_cjs.router3);
  app2.route("/admin/database-tools", createDatabaseToolsAdminRoutes());
  app2.route("/admin/seed-data", createSeedDataAdminRoutes());
  app2.route("/admin/content", chunkBGVZL6KN_cjs.admin_content_default);
  app2.route("/admin/media", chunkBGVZL6KN_cjs.adminMediaRoutes);
  app2.route("/admin/search", chunkBGVZL6KN_cjs.adminSearchRoutes);
  app2.route("/admin/api-keys", chunkBGVZL6KN_cjs.adminApiKeyRoutes);
  ...
  app2.route("/admin/plugins", chunkBGVZL6KN_cjs.adminPluginRoutes);
  app2.route("/admin/logs", chunkBGVZL6KN_cjs.adminLogsRoutes);
  app2.route("/admin", chunkBGVZL6KN_cjs.userRoutes);
  app2.route("/auth", chunkBGVZL6KN_cjs.auth_default);
  app2.route("/", chunkBGVZL6KN_cjs.test_cleanup_default);
...
Object.defineProperty(exports, "ROUTES_INFO", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.ROUTES_INFO; }
});
Object.defineProperty(exports, "adminApiRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.admin_api_default; }
});
Object.defineProperty(exports, "adminCheckboxRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.adminCheckboxRoutes; }
});
Object.defineProperty(exports, "adminCodeExamplesRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.admin_code_examples_default; }
});
Object.defineProperty(exports, "adminCollectionsRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.adminCollectionsRoutes; }
});
Object.defineProperty(exports, "adminContentRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.admin_content_default; }
});
Object.defineProperty(exports, "adminDashboardRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.router; }
});
Object.defineProperty(exports, "adminDesignRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.adminDesignRoutes; }
});
Object.defineProperty(exports, "adminLogsRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.adminLogsRoutes; }
});
Object.defineProperty(exports, "adminMediaRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.adminMediaRoutes; }
});
Object.defineProperty(exports, "adminPluginRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.adminPluginRoutes; }
});
Object.defineProperty(exports, "adminSettingsRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.adminSettingsRoutes; }
});
Object.defineProperty(exports, "adminTestimonialsRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.admin_testimonials_default; }
});
Object.defineProperty(exports, "adminUsersRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.userRoutes; }
});
Object.defineProperty(exports, "apiContentCrudRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.api_content_crud_default; }
});
Object.defineProperty(exports, "apiMediaRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.api_media_default; }
});
Object.defineProperty(exports, "apiRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.api_default; }
});
Object.defineProperty(exports, "apiSystemRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.api_system_default; }
});
Object.defineProperty(exports, "authRoutes", {
  enumerable: true,
  get: function () { return chunkBGVZL6KN_cjs.auth_default; }
});
Object.defineProperty(exports, "AuthManager", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.AuthManager; }
});
Object.defineProperty(exports, "PermissionManager", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.PermissionManager; }
});
Object.defineProperty(exports, "bootstrapMiddleware", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.bootstrapMiddleware; }
});
Object.defineProperty(exports, "cacheHeaders", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.cacheHeaders; }
});
Object.defineProperty(exports, "compressionMiddleware", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.compressionMiddleware; }
});
Object.defineProperty(exports, "detailedLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.detailedLoggingMiddleware; }
});
Object.defineProperty(exports, "getActivePlugins", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.getActivePlugins; }
});
Object.defineProperty(exports, "isPluginActive", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.isPluginActive; }
});
Object.defineProperty(exports, "logActivity", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.logActivity; }
});
Object.defineProperty(exports, "loggingMiddleware", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.loggingMiddleware; }
});
Object.defineProperty(exports, "optionalAuth", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.optionalAuth; }
});
Object.defineProperty(exports, "performanceLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.performanceLoggingMiddleware; }
});
Object.defineProperty(exports, "requireActivePlugin", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.requireActivePlugin; }
});
Object.defineProperty(exports, "requireActivePlugins", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.requireActivePlugins; }
});
Object.defineProperty(exports, "requireAnyPermission", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.requireAnyPermission; }
});
Object.defineProperty(exports, "requireAuth", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.requireAuth; }
});
Object.defineProperty(exports, "requirePermission", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.requirePermission; }
});
Object.defineProperty(exports, "requireRole", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.requireRole; }
});
Object.defineProperty(exports, "securityHeaders", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.securityHeadersMiddleware; }
});
Object.defineProperty(exports, "securityLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkWUZRX5SW_cjs.securityLoggingMiddleware; }
});
...
Object.defineProperty(exports, "MigrationService", {
  enumerable: true,
  get: function () { return chunk77JM55RB_cjs.MigrationService; }
});
